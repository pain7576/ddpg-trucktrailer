...
class RewardFunction:
    def __init__(self, observation, state, episode_steps, position_threshold, orientation_threshold, goalx, goaly):
        ...
        self.weights = {
            ...
            'orientation_alignment': 5.0,  # Reward for pointing correctly
    ...
    def calculate_orientation_alignment_reward(self):
        ...
        current_orientation = np.arctan2(self.observation[19], self.observation[20])
        ...
        alignment_reward = np.cos(angle_difference)
    ...
    def compute_reward(self):
        ...
        orientation_reward = self.calculate_orientation_alignment_reward()
        ...
        total_reward = (
                ...
                orientation_reward * self.weights['orientation_alignment'] +
        ...
        reward_info = {
            ...
            'orientation_reward': orientation_reward * self.weights['orientation_alignment'],
